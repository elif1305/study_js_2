...
//* kac tane book uretilmis bulmak istiyoruz;

class Book {
  //? static property  // instance lara gecmez.
  static counter = 0;   //instance tarafindan erisilmezler.  yani clg(book1.counter) yaparsak undefined gelir.
...
const book3 = new Book('Sinekli Bakkal', 'H.Edip Adivar', 1910);
